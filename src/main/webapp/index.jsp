		...
		<section id="header">
			...
			<div id = "top_box">
				<div id = "find_box">
					...
					<a href="index.jsp"><img src="./css/images/logo1.png" /></a>
				</div>
			</div>
					...
					<div id = "logo_box">
						<div id = "logo_box_in">
							<form method="post" name="totalFrm">
								...
								<input type = "button" name = "btnFind" id = "btn_find" style = "background-image: url('css/images/search.png'); background-repeat: no-repeat;" onclick = "toFind();"/>
							</form>
						</div>
					</div>
				</div>
